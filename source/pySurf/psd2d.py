...
def plot_rms_power(f,p,x=None,rmsrange=None,ax2f=None,units=None,*args,**kwargs):
    ...
    #c=plt.gca()._get_lines.prop_cycler  # 2025/04/22 matplotlib 3.9.2 not working any more # c = plt.rcParams['axes.prop_cycle'] # 2024/01/27 not working any more
    c = plt.rcParams['axes.prop_cycle']  # 2025/04/22 matplotlib 3.9.2, works again
